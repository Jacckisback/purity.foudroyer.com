...
seo:
  ...
  indexable: true
meta:
  title: "Découvrez les meilleurs livres numériques "
  description: Nous sommes là pour vous accompagner dans le choix de vos livres
  indexable: true
  image:
    src: ../assets/livres_nume_riques.jpeg
    alt: hero
...
content:
  - type: marketing/hero
    label:
      value: Découvrez le bon livre
      component: p
    title:
      value: Découvrez les meilleurs livres numériques à lire
      component: h1
    description: Notre équipe est là pour vous permettre de faire le bon choix de
      livre en fonctions de vos goûts et de vos besoins. N'hésitez pas à nous
      donner vos suggestions.
    image:
      src: ../assets/joshua-earle-9idqigrlute-unsplash-2-1-.jpeg
      alt: bienvenue sur Livre Numérique
    buttons:
